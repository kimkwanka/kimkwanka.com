// Code converted to TS from https://github.com/moxystudio/next-with-moxy/blob/master/www/app/use-fouc-fix.js
...
const useFixPageTransitionCSS = () =>
  useEffect(() => {
    ...
    const fixedStyleHrefs: Array<string | null> = [];
      ...
      newStyleEntries.forEach(({ element, href }) => {
        ...
        if (styleExists) {
          ...
          (element as HTMLElement).setAttribute(
            'data-fouc-fix-n-href',
            href || '',
          );
          (element as HTMLElement).removeAttribute('data-n-href');
...
export default useFixPageTransitionCSS;
